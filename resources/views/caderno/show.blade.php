                    ...
                    <li class="active">
                        <div id="accordion" role="tablist" aria-multiselectable="false" class="card-collapse">
                            <div class="card card-plain">
                                <div class="card-header display-flex" role="tab" id="headingOne">
                                    ...
                                    <div class="card-body">
                                        @if (isset($folhas))
                                            @foreach ($folhas as $folha)
                                                <a href="{{ route('folha.show',$folha->id) }}">
                                                    <h4>{{ $folha->name }}</h4>
                                                    <hr class="bg-white">
                                                </a>
                                            @endforeach
                                        @else
                                            <h6>Crie Sua primeira folha</h6>
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('folha.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>Titulo:</strong>
                                        <input type="text" name="caderno_id" class="form-control" hidden value="{{ $caderno->id }}">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <li class="adjustments-line">
                                <a href="javascript:void(0)" class="switch-trigger background-color">
                                    <div class="badge-colors text-center">
                                        ...
                                        <span class="badge filter badge-secondary" data-color="blue"></span>
